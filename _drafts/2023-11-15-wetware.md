...
Neural networks in nature I: Clever Cells
Neural networks in nature II: Protein circuits
Neural networks in nature III: Lessons for AI
...
We tend to think of biological intelligence as arising from animal nervous systems and brains. But consider this. E Coli pictured above is about 0.5 micron across. Thousands could sit in the the cross -section of a human hair. 0.5 micron is about the same size as a synapse on a dendrite of an animal neuron. Yet the E.Coli can process information, exhibits short-term memory and makes decisions to survive.
