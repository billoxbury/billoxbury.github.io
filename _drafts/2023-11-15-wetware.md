...
One question to consider is the evolutionary relationship between molecular neural networks in single cells and multi-celled nervous systems in animals. Did the latter evolve independently and by coincidence? Almost certainly not: it turns out that key (PPI) signalling pathways that control motor behaviour in bacteria and protozoa were co-opted by evolution for use in the firing of action potentials - that collectively determine the computational processes in the brain - between nerve cells. 

Consider this: a single dendritic spine - just one of a nerve cell's 1000s of receptors for incoming axons - is about the size of a bacterium and operates, like a bacterium, by having a complex of receptor proteins in its membrane. 
When the incoming axon fires, these receptors detect the neurotransmitter glutamate crossing the synapse. Some of the receptors can additionally detect the change of voltage within the spine that occurs when the receiving cell fires. This in turn can regulate an increase in sensitivity of that dentritic spine, driving a process of <a href="https://en.wikipedia.org/wiki/Hebbian_theory" target="_blank">Hebbian learning</a> for the formation of long-term memories in the brain.

In effect, evolution has co-opted ancient and successful signalling PPIs to solve the problem of scaling of information processing and intelligence in multi-cellular organisms - at least in animals - for which the basic processes of thermal diffusion and geometric recognition of molecules are no longer sufficient.

(Indeed, this raises a fascinating question for plants and fungi: these multi-cellular organisms must also process environmental information and decision-making, and the mechanisms for this can also be expected to be derived from ancestral single-cell PPIs. Can their (macroscopic) solutions likewise be modelled as neural networks?)

So here is the bad news for AI. As long as we seek to model anything of the complexity of the human brain (or of animal intelligence more generally), artificial neural networks, even at the scale of current deep learning systems and large language models - despite their success on the problems for which they are designed - will always be absolutely inadequate.
...
<p><small> Imprisoned in the crowded confines of the cortex, your pyramidal cells have no opportunity to escape. But there is nothing to stop them moving in place. They can grow and shrink, extend or retract their dendrites or branches of their axons. Their synaptic spines can be ... just as dynamic as an amoeba's pseudopodia. The movements of a nerve cell in the brain may be of shorter duration and harder to observe than those of a free-living cell, but why should they be less well informed? The millieu of such a cell is a rich and ever-changing broth of ions and neurotransmitters. There has been every opportunity for nerve cells evolving over millenia to learn how to extract information from this chemical soup.
</small></p>

But here's the good news. The model of artificial neural networks, stumbled upon as a huge but very happy over-simplification of animal brains, turns out to be more fundamental in biology than we realised. It should be no coincidence, then, that it's been so successful on such a broad range of hard tasks.
