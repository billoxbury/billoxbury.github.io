var store = [{
        ...
        "excerpt":"\"Draw a unicorn in TikZ.\" Successive renderings by GPT-4, from [1]. Their relevance to the discussion will be revealed, all in good time. This post is to review some remarkable observations by Microsoft and DeepMind researchers regarding the apparent ability of Large Language Models (LLMs) to solve mathematical problems. I...","categories": ["artificial_intelligence","mathematics"],
        "tags": [],
        "url": "/artificial_intelligence/mathematics/mathematics-vs-ai/",
        ...
        "tags": [],
        "url": "/artificial_intelligence/mathematics/cliffor-nn-notes/",
